...
help:
	...
	@echo "make install    - Install Linux binary and icon to local paths"
	@echo "make uninstall  - Uninstall Linux binary and icon from local paths"
